...
public class CatanMain {
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            ...
            int res = JOptionPane.showOptionDialog(new JFrame(), "Veuillez choisir le type d'affichage", "Groupe 48 - Les Colons de Catane", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, new ImageIcon("src/main/resources/icons8-question-32.png"), options, options[1]);
